...
/// [FavoritesRepository] held in memory.
///
/// The no-backend fallback and the tests' backend. Both operations are
/// idempotent here for the same reason the PostgREST version upserts: a double
/// tap must not become an error.
